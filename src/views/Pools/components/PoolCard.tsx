...
import { Button, IconButton, useModal, AddIcon, Image } from '@dragonsswap/uikit'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  const isOldSyrup = stakingToken.symbol === tokens.dragongold.symbol
